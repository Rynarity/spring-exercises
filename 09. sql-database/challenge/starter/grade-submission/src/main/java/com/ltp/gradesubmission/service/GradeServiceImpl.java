...
public class GradeServiceImpl implements GradeService {
    ...
    public Grade saveGrade(Grade grade, Long studentId, Long courseId) {
        ...
        Optional<Course> enrolledCourse = student.getCourses()
                .stream()
                .filter(studentCourse -> Objects.equals(studentCourse.getId(), courseId))
                .findFirst();
...
//        Course unwrappedCourse = CourseServiceImpl.unwrapCourse(enrolledCourse, courseId);
